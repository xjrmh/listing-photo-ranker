const REPOSITORY_URL = "https://github.com/xjrmh/listing-photo-ranker";
...
export function GitHubLink() {
  return (
    <a
      ...
      rel="noreferrer"
      className="icon-link"
      aria-label="Open the Listing Photo Ranker GitHub repository"
    ...
    >
      <svg viewBox="0 0 16 16" aria-hidden="true">
        <path
          ...
          -.36-1.02.08-2.12 0 0 .67-.21 2.2.82A7.54 7.54 0 0 1 8 3.5c.68 0 1.37.09 2.01.27
